...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Band',
            fields=[
                ('id', shortuuid.django_fields.ShortUUIDField(alphabet='23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', editable=False, length=8, max_length=8, prefix='', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='RelatedSource',
            fields=[
                ('id', shortuuid.django_fields.ShortUUIDField(alphabet='23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', editable=False, length=12, max_length=12, prefix='', primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('object_id', shortuuid.django_fields.ShortUUIDField(alphabet='23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', editable=False, length=8, max_length=14, prefix='')),
        ...
        migrations.CreateModel(
            name='Measurement',
            fields=[
                ('id', shortuuid.django_fields.ShortUUIDField(alphabet='23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', editable=False, length=14, max_length=14, prefix='', primary_key=True, serialize=False)),
                ...
                ('uncertainty_ew', models.FloatField(help_text='Total east-west (RA) uncertainty, quadratic sum of the measured error in RA and ew_sys_err (Deg).')),
                ('uncertainty_ns', models.FloatField(help_text='Total north-south (Dec) uncertainty, quadratic sum of the measured error in Dec and ns_sys_err (Deg).')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vast_pipeline.measurement')),
            ],
        ),
        migrations.CreateModel(
            name='Run',
            fields=[
                ...
                ('status', models.CharField(choices=[('INI', 'Initialised'), ('QUE', 'Queued'), ('RUN', 'Running'), ('END', 'Completed'), ('ERR', 'Error'), ('RES', 'Restoring'), ('DEL', 'Deleting')], default='INI', help_text='Status of the pipeline run.', max_length=3)),
                ...
                ('n_new_sources', models.IntegerField(default=0, help_text='number of new sources in this run')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vs_abs_significant_max_int', models.FloatField(default=0.0, help_text='Maximum value of all measurement pair variability t-statistics for int flux that exceed variability.source_aggregate_pair_metrics_min_abs_vs in the pipeline run configuration.')),
                ('m_abs_significant_max_int', models.FloatField(default=0.0, help_text='Maximum absolute value of all measurement pair modulation indices for int flux that exceed variability.source_aggregate_pair_metrics_min_abs_vs in the pipeline run configuration.')),
                ('vs_abs_significant_max_peak', models.FloatField(default=0.0, help_text='Maximum absolute value of all measurement pair variability t-statistics for peak flux that exceed variability.source_aggregate_pair_metrics_min_abs_vs in the pipeline run configuration.')),
                ('m_abs_significant_max_peak', models.FloatField(default=0.0, help_text='Maximum absolute value of all measurement pair modulation indices for  peak flux that exceed variability.source_aggregate_pair_metrics_min_abs_vs in the pipeline run configuration.')),
                ...
                ('related', models.ManyToManyField(through='vast_pipeline.RelatedSource', to='vast_pipeline.source')),
                ('run', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vast_pipeline.run')),
            ],
            options={
                'abstract': False,
            },
