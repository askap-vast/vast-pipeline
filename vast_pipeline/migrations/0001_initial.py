# Generated by Django 3.0.7 on 2020-11-03 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vs_significant_max_int', models.FloatField(default=0.0, help_text='Maximum value of all measurement pair variability t-statistics for int flux that exceed SOURCE_AGGREGATE_PAIR_METRICS_MIN_VS in the pipeline run configuration.')),
                ('m_abs_significant_max_int', models.FloatField(default=0.0, help_text='Maximum absolute value of all measurement pair modulation indices for int flux that exceed SOURCE_AGGREGATE_PAIR_METRICS_MIN_VS in the pipeline run configuration.')),
                ('vs_significant_max_peak', models.FloatField(default=0.0, help_text='Maximum value of all measurement pair variability t-statistics for peak flux that exceed SOURCE_AGGREGATE_PAIR_METRICS_MIN_VS in the pipeline run configuration.')),
                ('m_abs_significant_max_peak', models.FloatField(default=0.0, help_text='Maximum absolute value of all measurement pair modulation indices for peak flux that exceed SOURCE_AGGREGATE_PAIR_METRICS_MIN_VS in the pipeline run configuration.')),
