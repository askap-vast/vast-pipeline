...
function configureAladin(aladin, aladinConf) {
    ...
    var vast_epoch_01 = aladin.createImageSurvey(
        'VAST Pilot 01', 'VAST Pilot 01', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST1_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_01_v = aladin.createImageSurvey(
        'VAST Pilot 01 (Stokes V)', 'VAST Pilot 01  (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST1_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_02 = aladin.createImageSurvey(
        'VAST Pilot 02', 'VAST Pilot 02', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST2_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_02_v = aladin.createImageSurvey(
        'VAST Pilot 02 (Stokes V)', 'VAST Pilot 02 (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST2_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_03x = aladin.createImageSurvey(
        'VAST Pilot 03x', 'VAST Pilot 03x', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST3x_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_03x_v = aladin.createImageSurvey(
        'VAST Pilot 03x (Stokes V)', 'VAST Pilot 03x (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST3x_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_04x = aladin.createImageSurvey(
        'VAST Pilot 04x', 'VAST Pilot 04x', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST4x_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_04x_v = aladin.createImageSurvey(
        'VAST Pilot 04x (Stokes V)', 'VAST Pilot 04x (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST4x_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_05x = aladin.createImageSurvey(
        'VAST Pilot 05x', 'VAST Pilot 05x', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST5x_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_05x_v = aladin.createImageSurvey(
        'VAST Pilot 05x (Stokes V)', 'VAST Pilot 05x (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST5x_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_06x = aladin.createImageSurvey(
        'VAST Pilot 06x', 'VAST Pilot 06x', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST6x_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_06x_v = aladin.createImageSurvey(
        'VAST Pilot 06x (Stokes V)', 'VAST Pilot 06x (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST6x_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_07x = aladin.createImageSurvey(
        'VAST Pilot 07x', 'VAST Pilot 07x', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST7x_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_07x_v = aladin.createImageSurvey(
        'VAST Pilot 07x (Stokes V)', 'VAST Pilot 07x (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST7x_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_08 = aladin.createImageSurvey(
        'VAST Pilot 08', 'VAST Pilot 08', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST8_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_08_v = aladin.createImageSurvey(
        'VAST Pilot 08 (Stokes V)', 'VAST Pilot 08 (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST8_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_09 = aladin.createImageSurvey(
        'VAST Pilot 09', 'VAST Pilot 09', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST9_I4', 'equatorial', 6, {imgFormat: 'png'}
    );
    var vast_epoch_09_v = aladin.createImageSurvey(
        'VAST Pilot 09 (Stokes V)', 'VAST Pilot 09 (Stokes V)', 'https://www.atnf.csiro.au/people/Emil.Lenc/HiPS/VAST9_V4', 'equatorial', 6, {imgFormat: 'png'}
    );
