...
tr_selavy = {
    ...
    "ra_err": {'name': "selavy_ra_err", 'dtype': np.dtype(float)},
    "dec_deg_cont": {'name': "dec", 'dtype': np.dtype(float)},
    "dec_err": {'name': "selavy_dec_err", 'dtype': np.dtype(float)},
    "flux_peak": {'name': "flux_peak", 'dtype': np.dtype(float)},
    "flux_peak_err": {'name': "selavy_flux_peak_err", 'dtype': np.dtype(float)},
    "flux_int": {'name': "flux_int", 'dtype': np.dtype(float)},
    "flux_int_err": {'name': "selavy_flux_int_err", 'dtype': np.dtype(float)},
    "maj_axis": {'name': "bmaj", 'dtype': np.dtype(float)},
    "maj_axis_err": {'name': "selavy_err_bmaj", 'dtype': np.dtype(float)},
    "min_axis": {'name': "bmin", 'dtype': np.dtype(float)},
    "min_axis_err": {'name': "selavy_err_bmin", 'dtype': np.dtype(float)},
    "pos_ang": {'name': "pa", 'dtype': np.dtype(float)},
    "pos_ang_err": {'name': "selavy_err_pa", 'dtype': np.dtype(float)},
