...
def prep_skysrcs_df(image):
    '''
    read the parquet file from the image Django object and initialise
    the sky source dataframe used in the association logic
    '''
