# Generated by Django 3.0.5 on 2020-05-21 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rms_avg', models.FloatField(help_text='Background average RMS based on sigma clipping of image data (mJy)')),
                ('rms_min', models.FloatField(help_text='Background minimum RMS based on sigma clipping of image data (mJy)')),
                ('rms_max', models.FloatField(help_text='Background maximum RMS based on sigma clipping of image data (mJy)')),
