# Generated by Django 3.0.5 on 2020-08-14 00:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_snr', models.FloatField(help_text='The average signal-to-noise ratio value of the detections.')),
        ...
        migrations.AddField(
            model_name='source',
            name='related',
            field=models.ManyToManyField(related_name='_source_related_+', to='pipeline.Source'),
        ),
        migrations.AddField(
            model_name='source',
            name='run',
