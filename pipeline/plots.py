...
from pipeline.models import Measurement, Source
...
def plot_lightcurve(
    ...
    Args:
        ...
        vs_min (float, optional): MeasurementPair objects with a vs metric greater than `vs_min` and m metric greater than `m_min` will be connected in the metric graph. Defaults to 4.3.
        m_min (float, optional): See `vs_min`. Defaults to 0.26.
        use_peak_flux (bool, optional): If True, use peak fluxes, otherwise use integrated fluxes. Defaults to True.
