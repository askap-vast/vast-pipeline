...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {"unit_tags": "vast_pipeline.utils.unit_tags"},
        },
    },
]
...
SOCIAL_AUTH_GITHUB_ADMIN_TEAM = env(
    "SOCIAL_AUTH_GITHUB_ADMIN_TEAM", cast=str, default=""
)
...
STATICFILES_DIRS = env(
    "STATICFILES_DIRS", cast=list, default=[os.path.join(BASE_DIR, "static")]
)
STATIC_ROOT = env(
    "STATIC_ROOT", cast=str, default=os.path.join(BASE_DIR, "staticfiles")
)
...
DASK_DASHBOARD_HOST = env('DASK_DASHBOARD_HOST', cast=str, default='localhost')
...
DASK_NUM_IO_WORKERS = env('DASK_NUM_IO_WORKERS', cast=int, default=5)
DASK_NUM_DB_WORKERS = env('DASK_NUM_DB_WORKERS', cast=int, default=5)
...
PIPELINE_WORKING_DIR = env(
    "PIPELINE_WORKING_DIR", cast=str, default=os.path.join(BASE_DIR, "pipeline-runs")
)
...
RAW_IMAGE_DIR = env(
    "RAW_IMAGE_DIR", cast=str, default=os.path.join(BASE_DIR, "raw-images")
)
...
PIPELINE_MAINTAINANCE_MESSAGE = env(
    "PIPELINE_MAINTAINANCE_MESSAGE", cast=str, default=None
)
