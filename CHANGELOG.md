...
- Changed particles style on login page [#458](https://github.com/askap-vast/vast-pipeline/pull/458).
- Dependabot: Bump ini from 1.3.5 to 1.3.8 [#436](https://github.com/askap-vast/vast-pipeline/pull/436)

#### Fixed

- Fixed particles canvas sizing on login page [#458](https://github.com/askap-vast/vast-pipeline/pull/458).
- Fixed breadcrumb new line on small resolutitons [#458](https://github.com/askap-vast/vast-pipeline/pull/458).
...
- [#458](https://github.com/askap-vast/vast-pipeline/pull/458) fix: Fix particles and breadcrumb issues on mobile.
