...
- Fixed markupsafe to v2.0.1 for Jinja2 compatibility [#627](https://github.com/askap-vast/vast-pipeline/pull/627).
- Bumped all documentation dependancies to latest versions [#627](https://github.com/askap-vast/vast-pipeline/pull/627).
